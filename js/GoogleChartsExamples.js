...
args: [],
source: "makeData\x0a\x22Example Gauge Data\x22\x0a  ^ self class arrayToDataTable: { {'Label'.'Value'}.\x0a    \x09\x09\x09\x09\x09{'Memory' . 80}.\x0a                        {'CPU' . 55}.\x0a                        {'Network' . 68}}",
messageSends: ["arrayToDataTable:", "class"],
referencedClasses: []
}),
...
args: [],
source: "begin\x0a\x09\x22Start the executiong of the ExampleChartApp by connecting each button/graphic pair\x22\x0a    |pie divName|\x0a    divName = self getUniqueId.\x0a    console log:'divName :'.divName.\x0a    '<div id=\x22',divName,'\x22>Waiting for load...</div>'  appendToJQuery: 'body' asJQuery.\x0a    pie := PieChartExample new chartId:divName.\x0a    pie drawChartData:pie makeData options: pie makeOptions .\x0a    ^super begin",
messageSends: ["=", "getUniqueId", "log:", "appendToJQuery:", "asJQuery", ",", "chartId:", "new", "drawChartData:options:", "makeData", "makeOptions", "begin"],
...
args: [],
source: "makeData\x0a\x09\x22return a DataTable of example Pie Chart data\x22\x0a\x0a  ^ self class arrayToDataTable: { {'Task'.'Hours per Day'}.\x0a    \x09\x09\x09\x09\x09{'Work' . 11}.\x0a                        {'Eat'.2}.\x0a                        {'Commute'.2}.\x0a                        {'Watch TV'.2}.\x0a                        {'Snooze'.7}}",
messageSends: ["arrayToDataTable:", "class"],
referencedClasses: []
}),
...
args: [],
source: "makeData\x0a  \x22Return the example dataset\x22\x0a  ^ self class arrayToDataTable: { \x0a  \x09\x09\x09\x09\x09\x09\x09{'Age'.'Weight'}.\x0a                            {8 . 11} . \x0a                            { 4 . 5.5} . \x0a                            { 11 . 14 } . \x0a                            { 4 . 5}. \x0a                            {3 . 3} . \x0a                            {6.5 . 7}}\x0a     ",
messageSends: ["arrayToDataTable:", "class"],
referencedClasses: []
}),
